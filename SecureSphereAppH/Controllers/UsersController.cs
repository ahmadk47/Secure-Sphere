...
namespace SecureSphereApp.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Password,CreateAt,BranchId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Id,Name,Email,Password,CreateAt,BranchId")] User user)
        {
            //if (id != user.Id)
            //{
            //    return NotFound();
